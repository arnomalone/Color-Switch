...
//        totalStars = common.totalScore;
        ...
        rt.setDuration(Duration.seconds(5)); rt.setNode(circle0);
        rt.setByAngle(360); rt.setInterpolator(Interpolator.LINEAR);
        rt.setCycleCount(RotateTransition.INDEFINITE);
        rt.setAutoReverse(false); rt.play();
        RotateTransition rt1 = new RotateTransition();
        rt1.setDuration(Duration.seconds(5));
        rt1.setNode(circle1); rt1.setByAngle(360);
        rt1.setRate(-1); rt1.setInterpolator(Interpolator.LINEAR);
        rt1.setCycleCount(RotateTransition.INDEFINITE);
        rt1.setAutoReverse(false); rt1.play();
        RotateTransition rt3 = new RotateTransition();
        rt3.setDuration(Duration.seconds(5));
        rt3.setNode(logocircle0); rt3.setByAngle(360);
        rt3.setInterpolator(Interpolator.LINEAR);
        rt3.setCycleCount(RotateTransition.INDEFINITE);
        rt3.setAutoReverse(false); rt3.play();
        RotateTransition rt4 = new RotateTransition();
        rt4.setDuration(Duration.seconds(5));
        rt4.setNode(logocircle1); rt4.setByAngle(360);
        rt4.setInterpolator(Interpolator.LINEAR);
        rt4.setCycleCount(RotateTransition.INDEFINITE);
        rt4.setAutoReverse(false); rt4.play();
        RotateTransition rt5 = new RotateTransition();
        rt5.setDuration(Duration.seconds(5));
        rt5.setNode(circle2); rt5.setByAngle(360);
        rt5.setRate(-1); rt5.setInterpolator(Interpolator.LINEAR);
